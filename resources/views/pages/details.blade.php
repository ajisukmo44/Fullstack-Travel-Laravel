                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-information">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right">  {{ $item->price }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="join-container">
                        ...
                        <form action="{{ route('checkout_process', $item->id) }}" method="post">
                            @csrf
                          <button class="btn btn-block btn-join mt-0 py-2" type="submit">
                            Join Now
                          </button>
                        </form>
                        @endauth
                        @guest
                            <a href="{{ route('login') }}" class="btn btn-block btn-join py-2">
